...
<body>
	Hello,<br><br>A registered Alliance Business Solutions language services client
	<strong>
		%FName% %LName%
	</strong>
		has requested that the access for the Telephone Interpreter Hotline be provided to you.<br><br>
		For immediate access to a interpreter please call the number below and use the username and password noted below.<br><br>
